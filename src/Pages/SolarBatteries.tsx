    ...
    const Solar_pannel = [

        {
            ...
            features: [
                ...
                { text: "Specially Designed for solar inverter", icon: "https://cdn-icons-png.flaticon.com/128/11517/11517908.png" },
                { text: "Longer Life Span", icon: "https://cdn-icons-png.flaticon.com/128/11517/11517908.png" },
                { text: "Enhanced Heat Tolerance", icon: "https://cdn-icons-png.flaticon.com/128/11517/11517908.png" },
                { text: "Suitable for all types of UPS and inverter systems", icon: "https://cdn-icons-png.flaticon.com/128/11517/11517908.png" },

            ],
            warranty: "7Years Replacement 5 Years Prorate",
            high_efficiency: "High Efficiency",
            deep: "Deep Discharge Capability",
...

        {
            ...
            warranty: "6Years Replacement 6 Years Prorate",
            high_efficiency: "High Efficiency",
            deep: "Deep Discharge Capability",
...

        {
            ...
            warranty: "5 Years Replacement 5 Years Prorate",
            high_efficiency: "High Efficiency",
            deep: "Deep Discharge Capability",
                        ...
                        <div className=" bg-white  flex flex-col items-center mt-8 sm:mt-10" key={index} data-aos="zoom-in" data-aos-duration="600">
                            ...
                            <div className="rounded-lg shadow-lg p-5 flex flex-col items-center w-11/12 md:w-3/4 lg:w-[85rem]" style={{ backgroundImage: "linear-gradient(rgb(2, 82, 2),rgb(8, 134, 8))" }}>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-5 mt-10">
                                    ...
                                    <Link to={'/filter'} onClick={() => { UpdateKey(item.tittle.toUpperCase()) }} >
                                ...
                                {/* Details */}
                                <div className="mt-6 text-white text-center grid sm:grid-cols-3 grid-cols-1 gap-y-3 gap-x-10">

                                    <p className="font-medium">{item.high_efficiency}</p>
                                    <p className="font-medium">{item.deep}</p>
